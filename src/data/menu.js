...
export const products = [
     ...
     quoted rather than shopped. */
  {
    ...
    portions: [{ id: 'per-head', label: 'Per head', price: 5000 }],
    minQty: 20,
    unitNoun: 'people',
    options: [],
    featured: false,
  ...
  },
  {
    ...
    portions: [{ id: 'per-head', label: 'Per head', price: 7000 }],
    minQty: 20,
    unitNoun: 'people',
    options: [],
    featured: false,
  ...
  },
  {
    ...
    description: 'Edikainkong, sold by the litre.',
    includes: [],
    portions: potSizes(45000, 75000),
    options: [],
    featured: false,
     ...
     The separate "Pasta Price List" page. A box serves one, a bowl two. */
  {
    ...
    includes: [],
    portions: pastaServings(9000, 17000),
    options: [],
    featured: true,
    signature: false,
    tone: 'cream',
  ...
  },
  {
    ...
    includes: [],
    portions: pastaServings(7500, 15000),
    options: [],
    featured: false,
    signature: false,
    tone: 'deep',
     ...
     Bowl in the cart, trays quoted. */
  {
    ...
    includes: [],
    portions: saladSizes(8500, 35000, 45000),
    options: [],
    featured: true,
    signature: false,
    tone: 'green',
  },
  {
    ...
    includes: [],
    portions: saladSizes(9000, 35500, 45500),
    options: [],
    featured: false,
    signature: false,
    tone: 'cream',
